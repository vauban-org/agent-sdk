...
export function llmSpan(
  ...
  if (request.topP !== undefined) {
    span.setAttribute("gen_ai.request.top_p", request.topP);
  }
  if (request.seed !== undefined) {
    span.setAttribute("gen_ai.request.seed", request.seed);
  }
  return span;
}
...
export function recordLlmUsage(
  ...
  if (usage.responseId) {
    span.setAttribute("gen_ai.response.id", usage.responseId);
  }
}
