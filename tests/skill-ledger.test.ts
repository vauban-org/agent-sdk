...
import { type SkillLedgerEntry, resolveSkillsForAgent } from "../src/skills/skill-ledger.js";

// ─── Fixtures ──────────────────────────────────────────────────────────────────

function makeSkill(overrides: Partial<SkillLedgerEntry> & { id: string }): SkillLedgerEntry {
  return {
