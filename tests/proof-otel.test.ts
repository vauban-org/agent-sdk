...
// Chemin PRÉSENT : injection explicite du moteur (port setter), comme un hôte
// in-workspace au bootstrap. Chemin absent : proof-otel-unavailable.test.ts.
beforeAll(() => {
...
describe("toOtelSpan", () => {
  ...
  it("omits run.step.duration_ms when null", () => {
    ...
    expect(Object.prototype.hasOwnProperty.call(span.attributes, "run.step.duration_ms")).toBe(
      false,
    );
  });
  ...
  it("omits proof.leaf_hash_poseidon when null", () => {
    ...
    expect(Object.prototype.hasOwnProperty.call(span.attributes, "proof.leaf_hash_poseidon")).toBe(
      false,
    );
  });
  ...
  it("omits run.step.finished_at when null", () => {
    ...
    expect(Object.prototype.hasOwnProperty.call(span.attributes, "run.step.finished_at")).toBe(
      false,
    );
  });
